$(document).ready(function () {
 ...
 <div class="container">
          <div id="modal-js-example" class="modal">
            ...
            >
              <div
                ...
                id="fluid-container"
              >
                <div id="fwg_application_overlay_A3F"></div>
                <div id="fwg_application_spinner_A3F"></div>
                        ...
                        >
                          ...
                          <div>
                            <button
                              ...
                              id="website_type_service_submit"
                            >
                              <span
                              ...
                              >
                                ...
                                <span
                                  class="icon is-small is-hidden"
                                  id="website_type_service_selected_icon"
                                >
                            ...
                            <button
                              class="button is-info mt-4 text-align-left w-fit-content btn-outline-info q5-select-button"
                              id="website_type_store_submit"
                            >
                              <span
                                class="text-align-left full-width is-flex is-flex-direction-row is-align-content-center is-align-items-center"
                              >
                                <span class="radio-option-button">B</span>
                                <span>Shop or store</span>
                                <span
                                  class="icon is-small is-hidden"
                                  id="website_type_store_selected_icon"
                                >
                                  <i class="fas fa-check"></i>
                                </span>
                              </span>
                            ...
                            <button
                              class="button is-info mt-4 text-align-left w-fit-content btn-outline-info q5-select-button"
                              id="website_type_blog_submit"
                            >
                              <span
                                class="text-align-left full-width is-flex is-flex-direction-row is-align-content-center is-align-items-center"
                              >
                                <span class="radio-option-button">C</span>
                                <span>Blog</span>
                                <span
                                  class="icon is-small is-hidden"
                                  id="website_type_blog_selected_icon"
                                >
                                  <i class="fas fa-check"></i>
                                </span>
                              </span>
                            ...
                            <button
                              class="button is-info mt-4 text-align-left w-fit-content btn-outline-info q5-select-button"
                              id="website_type_other_submit"
                            >
                              <span
                                class="text-align-left full-width is-flex is-flex-direction-row is-align-content-center is-align-items-center"
                              >
                                <span class="radio-option-button">D</span>
                                <span>Other</span>
                                <span
                                  class="icon is-small is-hidden"
                                  id="website_type_other_selected_icon"
                                >
                                  <i class="fas fa-check"></i>
                                </span>
                              </span>
                    ...
                    <div class="is-flex is-flex-direction-column p-2 w-90">
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            class="py-4 is-flex is-flex-direction-row"
  ...
  var renderSelectedOption = (option) => {
    ...
    return `
      <div class="is-flex is-flex-direction-row flex-gap-2">
        <div class="is-flex is-flex-direction-row mr-2 flex-gap-2">
          <span class="icon flag-icon-container">
            <i class="fi fi-${identifier} selected-flag-icon-item"></i>
          </span>
        </div>
        <div class="is-flex is-flex-direction-row flex-gap-2">
          <span class="icon is-small">
            <i class="fa-solid fa-chevron-down purple-1 is-size-6"></i>
          </span>
        </div>
      </div>
        `;
  ...
  $("#phone_number").attr(
    "placeholder",
    selectedPhoneCode.format || "07 0123 4567"
  );
  ...
  var renderOption = (option) => {
    ...
    return `
 <div class="${identifier} select-option dropdown-item is-size-6 p-2 text-align-left">
    <div>
      <span class="icon">
        <i class="fi fi-${option.flagClassCode} flag-icon-item"></i>
      </span>
      &nbsp;&nbsp;
      ${option.name}
    </div>
  ...
  $(document).on("click", ".dropdown-item", function () {
    ...
    //change the placeholder of the phone number input
    $("#phone_number").attr(
      "placeholder",
      selectedPhoneCode.format || "07 0123 4567"
    );
  ...
  function createSessionInstanceUUID() {
    ...
    var uuid = "D-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (c) {
      var r = (dt + Math.random() * 16) % 16 | 0;
      dt = Math.floor(dt / 16);
      return (c == "x" ? r : (r & 0x3) | 0x8).toString(16);
    });
    return `D-${uuid.toUpperCase()}-${new Date().getTime()}`;
  }

  const widthIsGreaterThan1024px = window.innerWidth >= 1024;

  var SUBMIT_FORM_URL =
    "https://tools.thefreewebsiteguys.com/fwg/website-applications/submit-application/v3";
  var FORM_TRACKING_URL =
    "https://tools.thefreewebsiteguys.com/fwg/website-applications/aplica-partial/v3";
  ...
  var payload = {
    ...
    language: "en",
    sessionInstanceUUID,
    web_hosting: "Not Applicable",
    website_type: "",
  };

  let hasSubmitted = false;

  // Add better error handling for AJAX calls
  ...
  function showErrorMessage(message) {
    // Add HTML for error message display
    const errorDiv = $("<div>")
      .addClass("notification is-danger")
      .text(message);
    $("#form_submit_container").before(errorDiv);
    setTimeout(
      () =>
  ...
  function goToNextQuestion() {
    if (currentQuestion < totalQuestions) {
      if (currentQuestion == 1) {
        $(".left-nav-btn").removeClass("is-hidden");
      }

      if (currentQuestion == 3) {
        $(".right-nav-btn").addClass("is-hidden");
      }
  ...
  function goToPreviousQuestion() {
    if (currentQuestion > 1) {
      if (currentQuestion === 2) {
        $(".left-nav-btn").addClass("is-hidden");
      }

      if (currentQuestion === 4) {
        $(".right-nav-btn").removeClass("is-hidden");
      }
  ...
  /* Website Type */
  /* **********************************/
  // Define website types to handle
  const websiteTypes = ["service", "store", "blog", "other"];

  $("#website_type_service_submit").click(function () {
    payload.website_type = "Service website";

    // Hide all icons except selected one
    websiteTypes.forEach((type) => {
      const iconElement = $(`#website_type_${type}_selected_icon`);
      if (type === "service") {
        iconElement.removeClass("is-hidden");
      } else if (!iconElement.hasClass("is-hidden")) {
        iconElement.addClass("is-hidden");
      }
    });

    // Handle radio button selection states
    websiteTypes.forEach((type) => {
      const buttonElement = $(
        `#website_type_${type}_submit .radio-option-button`
      );
      if (type === "service") {
        buttonElement.addClass("selected-choice");
      } else {
        buttonElement.removeClass("selected-choice");
      }
    });
  ...
  $("#website_type_store_submit").click(function () {
    payload.website_type = "Online store";
  ...
  $("#website_type_blog_submit").click(function () {
    payload.website_type = "Blog website";
  ...
  $("#website_type_other_submit").click(function () {
    payload.website_type = "Other";
  ...
  $("#project_description_submit").click(function () {
    if (!payload.website_type || payload.website_type === "") {
      $("#project_description_required_error").removeClass("is-hidden");
      return;
    }
    $("#project_description_required_error").addClass("is-hidden");
    goToNextQuestion();
  });
  ...
  $("#email_address").on("input", function () {
    ...
    $("#email_address_required_error").addClass("is-hidden");
    $("#email_address_validation_error").addClass("is-hidden");
  });
  ...
  $("#phone_number").on("input", function () {
    // clear error messages
    $("#phone_number_required_error").addClass("is-hidden");
    $("#phone_number_validation_error").addClass("is-hidden");
    $("#searchInput").removeClass("is-danger");
    $("#country_code_required_error").addClass("is-hidden");
  });
  ...
  $(".input-box").keypress(function (e) {
    if (e.which == 13) {
      if (currentQuestion == 1) {
        const canShiftEnter = e.shiftKey && widthIsGreaterThan1024px;
        if (canShiftEnter || !widthIsGreaterThan1024px) {
          return;
        }
      }
  ...
  function showLoading() {
    $("#form_submit_button").addClass("is-loading").prop("disabled", true);
  }

  function hideLoading() {
    $("#form_submit_button").removeClass("is-loading").prop("disabled", false);
  }

  //Form submit button
  $("#form_submit_button").click(async function () {
    showLoading();
    try {
      payload.country_code = selectedPhoneCode;
      payload.phone_number = $("#phone_number").val();
      payload.website_type = payload.website_type || "Other";

      // Perform validation or any other logic here
      hasSubmitted = true;

      $(
        "#fwg_application_overlay_A3F, #fwg_application_spinner_A3F"
      ).fadeToggle();
            ...
            phone_number:
              phone_number?.length > 1
                ? phone_number?.startsWith("+")
                  ? `'${phone_number}`
                  : `'+${selectedPhoneCode.phoneCode}${phone_number}`
                : "",
            completed: true,
          },
        })
  ...
  //on press of enter, is the last question and either web hosting is yes or no, submit the form
  $(document).keypress(function (e) {
    if (e.which == 13) {
      if (
        currentQuestion == 5 &&
        !$("#form_submit_container").hasClass("is-hidden")
      ) {
  ...
  function closeModal($el) {
    ...
    // If phone no starts with a + then remove it, otherwise add the selected country code
  ...
  // Cache jQuery selectors that are used multiple times
  ...
  // Add form data persistence in case of accidental closure
  ...
  function loadFormProgress() {
    const savedData = sessionStorage.getItem("formProgress");
    if (savedData) {
  ...
  $(".input-box").on("change", saveFormProgress);
});
