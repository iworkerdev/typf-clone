            ...
            >
              ...
              <div id="fwg_application_spinner_A3F"></div>
                ...
                >
                  ...
                  <div class="is-flex is-flex-direction-row question-inactive question-container" id="question-3">
                    <div class="is-flex is-flex-direction-column p-2 w-90">
                      <div
                        class="is-flex is-flex-direction-row is-justify-content-flex-start is-align-items-flex-start flex-gap-4 full-width"
                      >
                  ...
                  <div class="is-flex is-flex-direction-row question-inactive question-container" id="question-4">
                    <div class="is-flex is-flex-direction-column p-2 w-90">
                      <div
                        class="is-flex is-flex-direction-row is-justify-content-flex-start is-align-items-flex-start flex-gap-4 full-width"
                      >
                  ...
                  <div class="is-flex is-flex-direction-row question-inactive question-container" id="question-5">
                    <div class="is-flex is-flex-direction-column p-2 w-90">
                      <div
                        class="is-flex is-flex-direction-row is-justify-content-flex-start is-align-items-flex-start flex-gap-4 full-width"
                      >
  ...
  $("#form_submit_button").click(function () {
    ...
    ajaxCall(
      ...
      JSON.stringify({
        ...payload,
        phone_number:
          payload.phone_number?.length > 3
            ? payload.phone_number?.startsWith("+")
              ? `'${payload.phone_number}`
              : `'+${selectedPhoneCode.phoneCode}  ${payload.phone_number}`
            : "",
        completed: true,
      })
    )
